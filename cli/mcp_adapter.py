...
Tools are now defined in cli/tools/ modules:
  ...
  - cli/tools/knowledge.py  — memory/cognify, memory/promote, memory/ingest,
                              memory/lesson_review, memory/lesson_promote,
                              memory/lesson_reject
...
def _memory_ingest(args):
    """Backward-compatible wrapper for tests."""
    from cli.tools.knowledge import _memory_ingest as _func
    return _func(args, args.get("daemon_url", "http://localhost:5051"))
